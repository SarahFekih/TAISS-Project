...
const csvData = fs.readFileSync('ffirstscenario.csv', 'utf-8' );
// const csvData = fs.readFileSync('datadump.csv', 'utf-8' );
// const csvData = fs.readFileSync('datadump1.csv', 'utf-8' );
